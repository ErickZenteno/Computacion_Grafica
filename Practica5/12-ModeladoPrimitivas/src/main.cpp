...
//incluimos las promitivas geometricas
#include "Headers/Sphere.h"
#include "Headers/Cylinder.h"
#include "Headers/Box.h"


Sphere sphere(20, 20,2.0f);
Cylinder cylinder(10, 10, 0.2, 0.5);
Box box;
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	cylinder.setColor(glm::vec3(0.0, 0.8, 0.7));
...
void applicationLoop() {
	...
	while (psi) {
		...
		//colocamos el objeto en la posicion de cero
		sphere.setPosition(glm::vec3(2.0f, 2.0f, -2.0f));
		//se setea la escala en tamaño del objeto
		sphere.setScale(glm::vec3(0.8, 0.8, 0.8));
		//se abilita que no sea solido el objeto
